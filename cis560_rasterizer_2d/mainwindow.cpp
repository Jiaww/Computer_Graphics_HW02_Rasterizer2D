...
void MainWindow::on_actionLoad_Scene_triggered()
{
    ...
    QJsonArray objects = jdoc.object()["root"].toArray();
...
void MainWindow::on_actionRenderingLines_triggered(){
    std::vector<Polygon> polygons;
    ...
    rendered_image = rasterizer.RenderLine();
    DisplayQImage(rendered_image);
...
void MainWindow::on_action4X_triggered(){
    ...
    rendered_image = rasterizer.AntiAliasing(2.0);
    DisplayQImage(rendered_image);
}

void MainWindow::on_action9X_triggered(){
    std::vector<Polygon> polygons;
    ...
    rendered_image = rasterizer.AntiAliasing(3.0);
    DisplayQImage(rendered_image);
}
...
void MainWindow::on_action16X_triggered(){
    ...
    rendered_image = rasterizer.AntiAliasing(4.0);
    DisplayQImage(rendered_image);
}
